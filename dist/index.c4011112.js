...
})({"6xtJk":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "8de6a437c4011112";
"use strict";
...
},{}],"939iF":[function(require,module,exports) {
var global = arguments[3];
// modules are defined as an array
// [ module function, map of requires ]
//
...
(function(modules, entry, mainEntry, parcelRequireName, externals, distDir, publicUrl, devServer) {
    ...
    /* eslint-enable no-undef */ /* eslint-enable no-undef */ const roles = [
        "Software Developer",
        "Frontend Developer",
        "Backend Developer",
    ...
    function typeWriter(text, i, cb) {
        ...
        } else setTimeout(cb, 1000); // wait before next word
    }
  ...
  */ var OVERLAY_ID = "__parcel__error__overlay__";
            ...
            if (!parent || !parent.isParcelRequire) {
                ...
                if (HMR_USE_SSE) ws = new EventSource("/__parcel_hmr");
                    ...
                    if (typeof WebSocket !== "undefined") try {
                        ...
                        if (err1.message && !err1.message.includes("Disallowed operation called within global scope")) console.error(err1.message);
                    }
                }
                if (ws) {
                    // $FlowFixMe
  ...
  ${frame.code}`;
    ...
    "a0t4e": [
        ...
        {
            "./scripts/scrollReveal": "1YCUQ",
            "./scripts/tiltAnimation": "4qDox",
            "./data/scrollRevealConfig": "aeHJJ",
...
},{}]},["6xtJk","939iF"], "939iF", "parcelRequire6aa4")

//# sourceMappingURL=index.c4011112.js.map
